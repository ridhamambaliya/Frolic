            ...
            after:absolute after:left-0 after:bottom-0 after:h-[3px] after:w-full ${card.border}`}
                >
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="mt-3 text-[24px] leading-none font-bold text-white">
                            {prizes?.[card.key] || ""}
                        </p>
                    ...
                    <div className="mt-8">
                        <input
                            ...
                            className="h-12 w-full rounded-2xl border border-white/10 bg-white/[0.03] px-4 text-[28px] font-semibold tracking-wide text-white outline-none placeholder:text-white/10 focus:border-white/20"
                        />
                    </div>
                </div>
            ))}
