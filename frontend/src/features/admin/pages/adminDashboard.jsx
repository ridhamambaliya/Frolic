...
import AdminDashboardAnalytics from "../components/DashboardAnalytics";
...
const AdminDashboard = () => {
  ...
  return (
    <AdminLayout>
      ...
      // action={<ActionButton onClick={generateReport}>Generate Report</ActionButton>}
      />
      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <AdminSectionCard className="p-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full text-left px-4 py-3 rounded-xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.06] transition"
                >
            ...
            <AdminSectionCard className="p-6">
              <h3 className="text-lg font-bold text-white mb-5">Coordinators</h3>
              <DashboardUserBox />
            </AdminSectionCard>
          </div>
        </div>
